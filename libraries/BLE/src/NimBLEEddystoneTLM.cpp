 ...
 */
const BLEEddystoneTLM::BeaconData BLEEddystoneTLM::getData() {
 ...
 */
void BLEEddystoneTLM::setData(const BLEEddystoneTLM::BeaconData &data) {
 ...
 */
void BLEEddystoneTLM::setTemp(int16_t temp) {
