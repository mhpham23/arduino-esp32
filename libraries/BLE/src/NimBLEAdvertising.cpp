...
BLEAdvertising::BLEAdvertising()
  : m_advData{}, m_scanData{}, m_advParams{}, m_advCompCb{nullptr}, m_slaveItvl{0}, m_duration{BLE_HS_FOREVER}, m_scanResp{false}, m_advDataSet{false} {
 ...
 */
bool BLEAdvertising::setDiscoverableMode(uint8_t mode) {
  switch (mode) {
 ...
 */
void BLEAdvertising::setAdvertisingInterval(uint16_t interval) {
 ...
 */
void BLEAdvertising::enableScanResponse(bool enable) {
  m_scanResp = enable;
  m_advDataSet = false;
}  // enableScanResponse
...
bool BLEAdvertising::start(uint32_t duration, const BLEAddress *dirAddr) {
  ...
  int rc = ble_gap_adv_start(
    BLEDevice::m_ownAddrType, (dirAddr != nullptr) ? dirAddr->getBase() : NULL, duration, &m_advParams,
    (pServer != nullptr) ? BLEServer::handleGapEvent : BLEAdvertising::handleGapEvent, this
  );
#else
 ...
 */
void BLEAdvertising::setAdvertisingCompleteCallback(advCompleteCB_t callback) {
 ...
 */
const BLEAdvertisementData &BLEAdvertising::getAdvertisementData() {
  return m_advData;
 ...
 */
const BLEAdvertisementData &BLEAdvertising::getScanData() {
  return m_advData;
}  // getScanData
 ...
 */
bool BLEAdvertising::refreshAdvertisingData() {
 ...
 */
bool BLEAdvertising::addServiceUUID(const BLEUUID &serviceUUID) {
 ...
 * @return True if the service was added successfully.
 */
bool BLEAdvertising::addServiceUUID(const char *serviceUUID) {
 ...
 */
bool BLEAdvertising::removeServiceUUID(const BLEUUID &serviceUUID) {
 ...
 */
bool BLEAdvertising::removeServices() {
 ...
 */
bool BLEAdvertising::setAppearance(uint16_t appearance) {
 ...
 */
bool BLEAdvertising::setPreferredParams(uint16_t minInterval, uint16_t maxInterval) {
 ...
 */
bool BLEAdvertising::addTxPower() {
 ...
 */
bool BLEAdvertising::setName(const std::string &name) {
 ...
 */
bool BLEAdvertising::setManufacturerData(const uint8_t *data, size_t length) {
 ...
 * @return True if the manufacturer data was set successfully.
 */
bool BLEAdvertising::setManufacturerData(const std::string &data) {
 ...
 * @return True if the manufacturer data was set successfully.
 */
bool BLEAdvertising::setManufacturerData(const std::vector<uint8_t> &data) {
 ...
 */
bool BLEAdvertising::setURI(const std::string &uri) {
 ...
 */
bool BLEAdvertising::setServiceData(const BLEUUID &uuid, const uint8_t *data, size_t length) {
 ...
 * @note If data length is 0 the service data will not be advertised.
 */
bool BLEAdvertising::setServiceData(const BLEUUID &uuid, const std::vector<uint8_t> &data) {
 ...
 * @note If data length is 0 the service data will not be advertised.
 */
bool BLEAdvertising::setServiceData(const BLEUUID &uuid, const std::string &data) {
