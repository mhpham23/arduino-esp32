 ...
 */
const BLEBeacon::BeaconData &BLEBeacon::getData() {
  return m_beaconData;
}  // getData
...
BLEUUID BLEBeacon::getProximityUUID() {
  return BLEUUID(m_beaconData.proximityUUID, 16).reverseByteOrder();
}  // getProximityUUID
 ...
 */
void BLEBeacon::setData(const BLEBeacon::BeaconData &data) {
  m_beaconData = data;
}  // setData
